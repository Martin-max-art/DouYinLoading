...
@implementation DouYinLoading

#pragma mark -
#pragma mark 显示/隐藏方法

+ (instancetype)showInView:(UIView *)view {
    DouYinLoading *loading = [[DouYinLoading alloc] initWithFrame:view.bounds];
...
+ (BOOL)hideInView:(UIView *)view {
    ...
    for (UIView *subview in subviewsEnum) {
        if ([subview isKindOfClass:self]) {
            DouYinLoading *loading = (DouYinLoading *)subview;
